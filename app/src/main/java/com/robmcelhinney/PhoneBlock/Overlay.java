...
public class Overlay extends Service {
    ...
    private void closeApps() {
        ...
        if (fgApp != null && (settings.getStringSet("selectedAppsPackageSocial", new HashSet<String>()).contains(fgApp)) || settings.getStringSet("selectedAppsPackageDesk", new HashSet<String>()).contains(fgApp)) {
